Pod::Spec.new do |spec|
	...
	spec.dependency "JYScreen", :git => 'https://github.com/JYYQLin/JYScreen.git', :commit => 'e798a5a'
	spec.dependency "JYExtension", :git => 'https://github.com/JYYQLin/JYExtension.git', :commit => '1fad9d1'
end
